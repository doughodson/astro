...
int main()
{
   ...
   if ((typerun != 'v') && (typerun != 'c')) {
      std::printf("input mfe, epoch (YMDHMS), or dayofyr approach, m,e,d \n\n");
      typeinput = getchar();
   } else {
      typeinput = 'e';
   }
         ...
         while ((tsince < stopmfe) && (satrec.error == 0)) {
            ...
            if (satrec.error == 0) {
               if ((typerun != 'v') && (typerun != 'c')) {
                  ...
                  std::fprintf(outfile, " %16.8f %16.8f %16.8f %16.8f %12.9f %12.9f %12.9f %5i%3i%3i %2i:%2i:%9.6f\n",
                  ...
                  std::fprintf(outfilee, " %16.6f %16.8f %16.8f %16.8f %12.9f %12.9f %12.9f \n", tsince * 60.0, ro[0],
                        ro[1], ro[2], vo[0], vo[1], vo[2]);

                  std::fprintf(outfile, " %16.8f %16.8f %16.8f %16.8f %12.9f %12.9f %12.9f", tsince, ro[0], ro[1],
                        ro[2], vo[0], vo[1], vo[2]);
                  ...
                  std::fprintf(outfile, " %14.6f %8.6f %10.5f %10.5f %10.5f %10.5f %10.5f %5i%3i%3i %2i:%2i:%9.6f\n", a,
                        ecc, incl * rad, node * rad, argp * rad, nu * rad, m * rad, year, mon, day, hr, min, sec);
               }
            } // if satrec.error == 0

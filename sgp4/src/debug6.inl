      if (help == 'y')
       //    if (dbgfile != NULL)
       {
         ...
         std::printf( " in and out variables \n");
         std::printf( "%7s%15.9f\n", "no", satrec.no);
         std::printf( "    outputs  :\n");
         std::printf( "%7s%15c%7s%15d%7s%15c%7s%15.9f\n",
         ...
         std::printf( "%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n",
         ...
         std::printf( "%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n",
           "xmcof",   satrec.xmcof,   "mdot",     satrec.mdot,
           "nodecf", satrec.nodecf, "nodedt", satrec.nodedot);
         std::printf( "   in and outputs from deep space satellites :\n");
         std::printf( "%7s%15.9f%7s%15.9f\n",
           "t", satrec.t, "nodeo", satrec.nodeo);
         std::printf( "%7s%15d%7s%15.9f%7s%15.9f%7s%15.9f%7s%15.9f\n",
